...
from app.services.static_analysis import LanguageDetector
...
async def review_code(request: Request, review_request: CodeReviewRequest) -> CodeReviewResponse:
    ...
    try:
        ...
        if review_request.language.lower() == "auto":
            detected = _language_detector.detect(
                code=review_request.code,
                filename=review_request.filename,
            )
            logger.info(
                "Auto-detected language: %s (filename=%s)",
                detected,
                review_request.filename,
            )
